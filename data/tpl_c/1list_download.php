...
<div class="body">
	...
	<div class="right">
		...
		<div class="box">
			...
			<li><span class="date"><?php echo date("Y-m-d",$value[post_date]);?>&nbsp;</span><a href="<?php echo site_url('download','id='.$value[download]);?>" style="<?php echo $value[style];?>" title="<?php echo $value[title];?>"><?php echo $value[title];?></a></li>
			<?php } ?>
			</ul>
